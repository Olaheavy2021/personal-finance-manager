...
public static class ValidatorNameResolver
{
    ...
    {
        if (expression == null) return memberInfo?.Name;
    ...
    public static string? ResolveDisplayName(Type _, MemberInfo? memberInfo, LambdaExpression __) => memberInfo?.Name.SplitPascalCase();
